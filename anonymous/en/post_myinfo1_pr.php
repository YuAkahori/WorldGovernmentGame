<html>
<head><title>SIZOOKA COUNTRY</title></head>
<body>
...
print($use.'のシゾーカ県内での居場所を表示します。137-x-139.5 34-y-36 <br>');
...
//up
    ...
    if (isset($_POST['bt_up'])) {
        header("Location:post_up1_a1_01.php");
    }
//dowm
    elseif (isset($_POST['bt_down'])) {
        header("Location:post_down1_a1_01.php");
        }
//left
    elseif (isset($_POST['bt_left'])){
        header("Location:post_left1_a1_01.php");
        }
//right
elseif (isset($_POST['bt_right'])){
        header("Location:post_right1_a1_01.php");
        }
//４　リスト表示
