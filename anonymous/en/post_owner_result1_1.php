...
print('1度ごとのオーナー情報一覧を表示します。<br>');

pg_set_client_encoding("utf8");


$result = pg_query("select * from   wgg_land_registry_sc.wgg_land_registry_s1_tb ");
if (!$result)   {
...
//    print('id='.$rows['id'].' ');
    print('検索id='.$rows['lr_1_auto_id'].':');
    print('X座標='.$rows['lr_longitude_1_x'].':');
    print('Y座標='.$rows['lr_latitude_1_y'].':');
