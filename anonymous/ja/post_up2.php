...
$result = pg_query('insert into wgg_location_sc.wgg_location_wgg_dbmaster_tb (mylongitude_x,mylatitude_y) values(125,30) ');
if (!$result) {
...
?>
<BODY onLoad=setTimeout("location.href='post_myinfo3_co.php'",3000)>
