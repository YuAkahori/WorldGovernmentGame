<html>
<head><title>JAPA COUNTRY</title></head>
<body>
...
print('ジャパ国内での居場所を表示します。120-x-154 20-y-46 <br>');
...
button {
 ...
 <form action="post_myinfo8_co.php" method="post">
...
//up
    ...
    if (isset($_POST['bt_up'])) {
        header("Location:post_up1_8.php");
    }
//dowm
    elseif (isset($_POST['bt_down'])) {
        header("Location:post_down1_8.php");
        }
//left
    elseif (isset($_POST['bt_left'])){
        header("Location:post_left1_8.php");
        }
//right
elseif (isset($_POST['bt_right'])){
        header("Location:post_right1_8.php");
        }
//４　リスト表示
