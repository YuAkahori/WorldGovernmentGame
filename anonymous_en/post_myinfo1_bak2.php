...
<head><title>MIYA AREA</title></head>
<body>
...
//change
print('ミヤ市内での居場所を表示します。138.5-x-138.75 35.16-y-35.46 <br>');

pg_set_client_encoding("utf8");

$result = pg_query('SELECT * FROM wgg_location_sc.wgg_location_wgg_dbmaster_tb order by id ');
...
//id 1 の座標が掲載される 
 <?php $n2 =0?>
var lx=<?php echo $img_location_x; ?> ;
var ly=<?php echo $img_location_y; ?> ;
 move(lx,ly);
...
// 横幅が500 縦幅が600 ある
// 138.50 x  138.75 0.25   2000 

// 35.16 y 35.46    0.30   2000
...
//up
    ...
    if (isset($_POST['bt_up'])) {
        header("Location:post_up001_1.php");
    }
//dowm
    elseif (isset($_POST['bt_down'])) {
        header("Location:post_down001_1.php");
        }
//left
    elseif (isset($_POST['bt_left'])){
        header("Location:post_left001_1.php");
        }
//right
elseif (isset($_POST['bt_right'])){
        header("Location:post_right001_1.php");
        }
//４　リスト表示
