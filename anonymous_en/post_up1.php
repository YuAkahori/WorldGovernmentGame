...
$result = pg_query('update wgg_location_sc.wgg_location_wgg_dbmaster_tb set mylatitude_y=mylatitude_y+1  where id =1 ');
if (!$result) {
...
?>
<BODY onLoad=setTimeout("location.href='post_myinfo6_co.php'",0)>
</body>
</html>
