...
button  {
 ...
 <form action="post_myinfo5_co.php" method="get">
    ...
    <br>
    <input type="hidden" name="text2" value =10 >

    <button type="submit" name="bt_up" value=1>上</button>
    <button type="submit" name="bt_down"value=2>下</button>
    <button type="submit" name="bt_left"value=3>左</button>
    <button type="submit" name="bt_right"value=4>右</button>
