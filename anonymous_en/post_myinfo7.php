...
print($use.'のワープ後の世界での場所を表示します。<br>');
...
if (-180<$x && $x < 180  ) {
if (-90 < $y && $y < 90){
$state = "update  wgg_location_sc.wgg_location_".$use."_tb
set mylongitude_x='$x', mylatitude_y='$y' where id =1";
$result1 = pg_query($state);
if (!$result1) {
    die('クエリーが失敗しました。'.pg_last_error());
}
                        }
                        }
$state1 = "select * from  wgg_location_sc.wgg_location_".$use."_tb";

$result = pg_query($state1);
