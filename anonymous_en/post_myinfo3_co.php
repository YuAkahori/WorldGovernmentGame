...
print($use.'のジャパ国内での居場所を表示します。120-x-154 20-y-46 <br>');
...
//up
    ...
    if (isset($_POST['bt_up'])) {
        header("Location:post_up1_a1.php");
    }
//dowm
    elseif (isset($_POST['bt_down'])) {
        header("Location:post_down1_a1.php");
        }
//left
    elseif (isset($_POST['bt_left'])){
        header("Location:post_left1_a1.php");
        }
//right
elseif (isset($_POST['bt_right'])){
        header("Location:post_right1_a1.php");
        }
//４　リスト表示
